...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal data-cid="element-VHScFN">
    <SelectPrimitive.Content
      data-cid="element-PxBwGy"
      ref={ref}
      className={cn(
      ...
      {...props}
    >
      <SelectScrollUpButton data-cid="SelectScrollUpButton-jhSmJ1" />
      <SelectPrimitive.Viewport
        data-cid="element-FVwLGu"
        className={cn(
          'p-1',
          position === 'popper' &&
      ...
      <SelectScrollDownButton data-cid="SelectScrollDownButton-rz2AoS" />
    </SelectPrimitive.Content>
